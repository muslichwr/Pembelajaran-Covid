...
import static com.mumus.pembelajarancovid.QuizNama.list;



public class QuizPertanyaan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quizpertanyaan);
        ...
        countDownTimer = new CountDownTimer(20000, 1000) {
            ...
            public void onFinish() {
                Dialog dialog = new Dialog(QuizPertanyaan.this, R.style.Dialoge);
